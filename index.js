    ...
    for (let b of active) {
      ...
      cards += `
        <div style="border:1px solid #eee; border-radius:16px; padding:16px; margin:12px; max-width:300px; display:inline-block; vertical-align:top; background:#fff;">
          ...
          <br>
          <a href="tg://resolve?domain=ваш_ник_в_телеграме" style="display:inline-block; margin-top:12px; background:#4CAF50; color:#fff; padding:10px 20px; border-radius:30px; text-decoration:none;">📩 Заказать в Telegram</a>
        </div>
      `;
    }
  }
